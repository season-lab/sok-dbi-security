...
// Note: assert_* methods have been borrowed from libdft-dta.c

// If instrumentForTaintCheck() is not used, code in this file
// is essentially dead. We used it for some debugging.
